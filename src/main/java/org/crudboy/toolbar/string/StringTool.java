...
public class StringTool {
    ...
    public static int getSingleDigitFromChinese(String signleDigitChinese) {
        int digit = 0;
        switch (signleDigitChinese) {
            case "一":
                digit = 1;
                break;
            case "二":
            ...
            case "九":
                ...
                break;
            default:
                throw new ToolbarRuntimeException("StringTool-getSingleDigitFromChinese error");
        }
        return digit;
    }
